...
export const projectReports = {
  en: {
    ...
    project4: {
      title: "TotalEnergies Waste Valorization KPI Dashboard",
      leadParagraph:
        "PLACEHOLDER CONTENT (copied from project 3, pending real write-up): A retail analytics dashboard built on the classic Superstore dataset, tracking over $2.3M in total sales across four US regions. Designed to surface profitability drivers, seasonal trends, and category-level performance in a single interactive view.",
      description:
        "This project showcases an interactive Power BI dashboard focused on retail sales performance. The goal is to highlight monthly trends, regional concentration, and the top sub-categories driving revenue and profit margin.",
      pills: ["Power BI", "DAX", "Data Modeling", "Retail Analytics"],
      skills: [{ title: "Power BI", icon: IconKeys.powerbi }],
    ...
    project5: {
      title: "Laboratory Chemical Reagent Inventory Dashboard",
      leadParagraph:
        "PLACEHOLDER CONTENT (copied from project 3, pending real write-up): A retail analytics dashboard built on the classic Superstore dataset, tracking over $2.3M in total sales across four US regions. Designed to surface profitability drivers, seasonal trends, and category-level performance in a single interactive view.",
      description:
        "This project showcases an interactive Power BI dashboard focused on retail sales performance. The goal is to highlight monthly trends, regional concentration, and the top sub-categories driving revenue and profit margin.",
  ...
  es: {
    ...
    project4: {
      title: "Dashboard de KPIs de Valorización de Residuos — TotalEnergies",
      leadParagraph:
        "CONTENIDO PROVISORIO (copiado del proyecto 3, pendiente de redactar el real): Un dashboard de analítica retail construido sobre el clásico dataset de Superstore, que sigue más de $2.3M en ventas totales en cuatro regiones de EE.UU. Diseñado para mostrar los motores de rentabilidad, las tendencias estacionales y la performance por categoría en una sola vista interactiva.",
      description:
        "Este proyecto presenta un dashboard interactivo en Power BI enfocado en la performance de ventas retail. El objetivo es destacar las tendencias mensuales, la concentración regional y las principales subcategorías que impulsan los ingresos y el margen de ganancia.",
      pills: ["Power BI", "DAX", "Modelado de Datos", "Análisis Retail"],
      skills: [{ title: "Power BI", icon: IconKeys.powerbi }],
    ...
    project5: {
      title: "Dashboard de Inventario de Reactivos Químicos de Laboratorio",
      leadParagraph:
        "CONTENIDO PROVISORIO (copiado del proyecto 3, pendiente de redactar el real): Un dashboard de analítica retail construido sobre el clásico dataset de Superstore, que sigue más de $2.3M en ventas totales en cuatro regiones de EE.UU. Diseñado para mostrar los motores de rentabilidad, las tendencias estacionales y la performance por categoría en una sola vista interactiva.",
      description:
        "Este proyecto presenta un dashboard interactivo en Power BI enfocado en la performance de ventas retail. El objetivo es destacar las tendencias mensuales, la concentración regional y las principales subcategorías que impulsan los ingresos y el margen de ganancia.",
